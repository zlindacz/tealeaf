...
class InstrumentsControllerTest < ActionController::TestCase
  ...
  test "should create instrument" do
    assert_difference('Instrument.count') do
      post :create, instrument: { instrument: @instrument.instrument, player_name: @instrument.player_name, years_of_playing: @instrument.years_of_playing }
    end
  ...
  test "should update instrument" do
    patch :update, id: @instrument, instrument: { instrument: @instrument.instrument, player_name: @instrument.player_name, years_of_playing: @instrument.years_of_playing }
    assert_redirected_to instrument_path(assigns(:instrument))
  end
